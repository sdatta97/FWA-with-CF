...
for idxBSDensity = 1:length(lambda_BS)
    ...
    for idxUEDensity = 1:length(lambda_UE)
        ...
        for idxrmin = 1:length(r_min_arr)
            ...
            rateFolder = strcat(dataFolder,'/FWA_multi_cell_repeater_fixed_FWA_cf_repeat_ul');
            ...
            lambda_UE(idxUEDensity),deployRange,params.r_min_cell,params.r_min_FWA,K_FWA_max,Band,Band_FWA, sum(mean_rate_ul_cell)/(Band - Band_FWA), sum_FWA_rate/(Band_FWA*K_FWA_max));
            fclose(fileID);
        end
    end
end
