...
projectdir = '/Users/sdatta/Desktop/FWA_data/FWA_cell_revised_results';
dinfo = dir(fullfile(projectdir, 'results_*20lambdaBS_100lambdaUE*pfac*.csv'));   %use appropriate extension
...
writetable(summaryTable,'./rate_comp_fwa_cell_20lambda_BS_100lambda_UE_combined_var_pfac.txt')
writetable(summaryTable,'./rate_comp_fwa_cell_20lambda_BS_100lambda_UE_combined_var_pfac.csv')